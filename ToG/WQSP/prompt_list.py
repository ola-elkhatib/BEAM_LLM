extract_relation_prompt = """Please retrieve %s relations (separated by semicolon) from the list of relations provided that contribute to the question and rate their contribution on a scale from 0 to 1 (the sum of the scores of %s relations is 1). Select relations only from the list provided.
Q1: Name the president of the country whose main spoken language was Brahui in 1980?
Topic Entity: Brahui Language
Relations: language.human_language.main_country; language.human_language.language_family; language.human_language.iso_639_3_code; base.rosetta.languoid.parent; language.human_language.writing_system; base.rosetta.languoid.languoid_class; language.human_language.countries_spoken_in; kg.object_profile.prominent_type; base.rosetta.languoid.document; base.ontologies.ontology_instance.equivalent_instances; base.rosetta.languoid.local_name; language.human_language.region
A1: 1. {language.human_language.main_country (Score: 0.4))}: This relation is highly relevant as it directly relates to the country whose president is being asked for, and the main country where Brahui language is spoken in 1980.
...
Q1: Find the person who said \"Taste cannot be controlled by law\", what did this person die from?
Knowledge Triplets: Taste cannot be controlled by law., media_common.quotation.author, Thomas Jefferson
A1: Based on the given knowledge triplets, it's not sufficient to answer the entire question. The triplets only provide information about the person who said "Taste cannot be controlled by law," which is Thomas Jefferson. To answer the second part of the question, it's necessary to have additional knowledge about where Thomas Jefferson's dead.

Q2: The artist nominated for The Long Winter lived where?
...
A2: Based on the given knowledge triplets, the author of The Long Winter, Laura Ingalls Wilder, lived in De Smet. Therefore, the answer to the question is {De Smet}.

Q3: Who is the coach of the team owned by Steve Bisciotti?
...
A4: Based on the given knowledge triplets, Rift Valley Province is located in Kenya, which uses the Kenyan shilling as its currency. Therefore, the answer to the question is {Kenyan shilling}.

Q5: The country with the National Anthem of Bolivia borders which nations?
...
Knowledge Triplets: Russia, location.country.form_of_government, semi-presidential system
Russia, location.country.form_of_government, constitutional republic
Russia, location.mailing_address.state_province_region, UnName_Entity
A:{Yes}.Based on the given knowledge triplets, The form of government in Russia is semi-presidential system and constitutional republic.  Therefore, the answer to the question is {semi-presidential system|constitutional republic}.

"""

force_answer="""Given a question and the associated retrieved knowledge graph triplets (entity, relation, entity), you are asked to answer the question with these triplets and your knowledge.
Q: The artist nominated for The Long Winter lived where?
Knowledge Triplets: The Long Winter, book.written_work.author, Laura Ingalls Wilder
Laura Ingalls Wilder, people.person.places_lived, Unknown-Entity
Unknown-Entity, people.place_lived.location, De Smet
...
Russia, location.country.form_of_government, constitutional republic
Russia, location.mailing_address.state_province_region, UnName_Entity
A:Based on the given knowledge triplets, The form of government in Russia is semi-presidential system and constitutional republic.  Therefore, the answer to the question is {semi-presidential system|constitutional republic}.

"""

generate_directly = """Instruction: Answer the question step by step. Always enclose the final answer in curly braces {}.
...
Q: what movie is josh hutcherson in?
A: Josh Hutcherson has appeared in several well-known movies like: Bridge to Terabithia, Zathura: A Space Adventure, Journey to the Center of the Earth, The Kids Are All Right, and RV. The answer is {Bridge to Terabithia, Zathura: A Space Adventure, Journey to the Center of the Earth, The Kids Are All Right, and RV}
